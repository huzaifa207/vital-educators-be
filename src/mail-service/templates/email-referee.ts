              ...
              >
                ...
                <tr>
                  ...
                  >
                    ...
                    <p>You have been selected as a referee by ${name} as part of an ID checking system implemented by Vital Educators. You are kindly requested to please complete a a short on-line form which will confirm ${name}'s identity and allow them to use Vital Educators to offer their private tuition services. It is a short form and should take no longer than 2 minutes to complete. Please note: the completed reference form will be passed on to any clients who choose ${name} as their tutor, but your contact information will remain confidential. </p>
