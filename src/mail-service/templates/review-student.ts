export const studentReview = (tutorName: string, studentName: string) => `
        <!DOCTYPE html>
        <html>
        <head>
        <meta charset="utf-8" />
            ...
            <td align="center" bgcolor="#e9ecef">
                ...
                <tr>
                    ...
                    <h2 style="
                                        ...
                                        text-align: center;
                                    ">
                        ${studentName} Gives you a review
                    </h2>
                    </td>
                </tr>
                </table>
            ...
            <td align="center" bgcolor="#e9ecef">
                ...
                <tr>
                    ...
                    <p style="margin: .5em 2em;text-align:left; font-weight:300; color:'#ccc'">
                        hope that my feedback will be helpful in helping you to continue improving your skills and better serving your students.
                    </p>
                    <p style="margin: 1em 2em; text-align:left;font-weight:300; color:'#ccc'">
                    Thank you for the opportunity to provide my thoughts on your tutoring. If you have any questions or concerns, please don't hesitate to let me know.
            ...
            <td align="center" bgcolor="#e9ecef" style="padding: 24px">
                ...
                <tr>
                    <td align="center" bgcolor="#e9ecef" style="
                                    ...
                                    ">
                    <p style="margin: 0">
                        You received this email because a student name <b>${studentName}</b> gives you feedback.
                    </p>
                    </td>
                </tr>
                <!-- end permission -->
