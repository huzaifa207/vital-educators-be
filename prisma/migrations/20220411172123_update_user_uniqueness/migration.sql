/*
  ...
  - A unique constraint covering the columns `[email_token]` on the table `User` will be added. If there are existing duplicate values, this will fail.
...
*/
-- CreateIndex
CREATE UNIQUE INDEX "User_email_token_key" ON "User"("email_token");
